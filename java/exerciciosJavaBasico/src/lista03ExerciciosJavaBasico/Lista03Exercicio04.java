...
public class Lista03Exercicio04 {
	public static void main(String[] args)
	{
		...
		int totalF, totalM, totalO, pessoasCalmas=0, mulheresNervosas=0,
				homensAgressivos=0, outrosCalmos=0, nervosas40=0, calmasMenor18=0;
		
		int contador = 1;
		System.out.println("------- SISTEMA DE PESQUISA DA CIDADE-----------------");
